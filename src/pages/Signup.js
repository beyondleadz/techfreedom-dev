          ...
          <div className="main-agile1">
            <div class="main-agile">
              ...
              <div class="content-wthree">
                ...
                <br />
                <h6>
                  <i class="fa fa-check-circle" aria-hidden="true"></i> Step 1{" "}
                  <i class="fa fa-arrow-down" aria-hidden="true"></i>
                </h6>
                <p align="left">Set your name, email or continue.</p>
                <h6>
                  <i class="fa fa-dot-circle-o" aria-hidden="true"></i> Step 2{" "}
                  <i class="fa fa-arrow-down" aria-hidden="true"></i>
                </h6>
                <p>Tell us about your company details</p>
                <h6>
                  <i class="fa fa-dot-circle-o" aria-hidden="true"></i> Step 3{" "}
                  <i class="fa fa-arrow-down" aria-hidden="true"></i>
                </h6>
                <p>Great! Tell us something more about your profile</p>
                <br />
            ...
            <div class="w3layouts-main">
              ...
              {step.step1 && <Signup1 changeStep={changeStep} />}
              {step.step2 && (
                <Signup2 changeStep={changeStep} signupData={signupData} />
              )}
              {step.step3 && (
                <Signup3 submitData={submitData} signupData={signupData} />
              )}
            </div>
            <div class="clear"></div>
          </div>
