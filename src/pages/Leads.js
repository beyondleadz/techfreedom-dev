        ...
        <div className="mb-4">
            ...
            <div>
                ...
                <div className="mt-4 mb-2">
                    <code>.btn-circle .btn-sm</code>                                    </div>
                ...
                <div className="mt-4 mb-2">
                    <code>.btn-circle .btn-lg</code>                                    </div>
                ...
                <a href="#" className="btn btn-danger btn-circle btn-lg">
                    <i className="fas fa-trash"></i>                                    </a>                                </div>
        </div>
        ...
        <div className=" mb-4">
            ...
            <div>
                ...
                <a href="#" className="btn btn-facebook btn-block"><i
                        className="fab fa-facebook-f fa-fw"></i> .btn-facebook</a>                                </div>
        </div>
    </div>
