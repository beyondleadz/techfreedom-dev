...
export const errEnum = {
  ...
  DASHBOARD_GROUPED_BYSOURCE_ERROR:'DASHBOARD_GROUPED_BYSOURCE_ERROR',
  DASHBOARD_GROUPED_BYINDUSTRY_ERROR:'DASHBOARD_GROUPED_BYINDUSTRY_ERROR',
  DASHBOARD_GROUPED_BYACTIVITY_ERROR:'DASHBOARD_GROUPED_BYACTIVITY_ERROR'
};
