...
const CompanyPdfFormat=()=>{
    return <>
<div className="pdfWrapperStyle" style={{fontFamily: "sans-serif", padding: "10px",    fontSize:"14px"}}>
{/* backgroundImage: url(images/bg.jpg);   background-repeat: repeat-y;    background-position: unset;    background-size: 100%; */}
          
<div style={{float: "left",  width: "75%",   backgroundColor: "#ffffff",  display: "tableCell", height: "692px"}}>
  <div style={{display: "flex",   margin: "25px 5px 0 5px"}}>
<div style={{ display: "tableCell",  width:"100%"}}>
 <div style={{ backgroundColor:"#5d44ff", width: "100px", height: "67px", padding: "10px",color: "#fff",fontSize: "21px",fontWeight: "bold",lineHeight: "22px", marginLeft: "50px", marginTop: "5px",  boxShadow: "0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19)"}}><img src={PDFLOGO} width="76px" height="auto"/></div>
</div>
	...
	<div style={{marginRight: 72,marginLeft: "5px", backgroundColor: "#f7f6f1",padding: "5px 16px",borderRadius: 50,color: "#000", fontSize:12}}>
	...
	<div style={{fontWeight: 400,boxSizing: "borderBox",width: "95%",marginTop: "35px",fontSize: 12,lineHeight: 22,textAlign: "justify",paddingRight: 0,position: "relative"}}>
...
<div className="step">Product and Services</div>
	...
	<div style={{display: "inline-table", marginTop: 20}}><strong> Ayurvedic/Natural Health & Personal care , Packaged Juices , Hair Care ,
...
Ayurveda</strong></div>
  ...
  <div style={{float: "left",width: "25%",backgroundColor: "#fdc401",
  paddingLeft: "20px", color: "#575656",  display: "tableCell", height: "692px", borderRadius: "0 15px 15px 0",
  backgroundImage: "linearGradient(#fdc401, #fff)", display: "tableCell"}}>
  <div style={{padding: "10px",
  marginTop: "10px", textAlign: "right",
    fontSize: 12,
    margin: "0 20px 45px 20px",
    color: "#000"}}>Time Stamp: 07-07-2023 / 06 : 30 : 45 pm</div>
    <div style={{padding: "10px", marginTop: "10px"}}>
	<div style={{margin:"20px 10px"}}>
	<div className="title">Employees Range</div>
	<div style={{fontSize:"13px", fontWeight:"bold"}}>5000 & Above</div>
	</div>
	
	<div style={{margin:"20px 10px"}}>
	<div className="title">Revenue Range</div>
	<div style={{fontSize:"13px", fontWeight:"bold"}}>5001 & Above</div>
	</div>
	
	<div style={{margin:"20px 10px"}}>
	<div className="title">Company Type</div>
	<div style={{fontSize:"13px", fontWeight:"bold"}}>Public Limited</div>
	</div>
	
	<div style={{margin:"20px 10px"}}>
	<div className="title">Industry </div>
	<div style={{fontSize:"13px", fontWeight:"bold"}}>Consumer Goods</div>
	</div>
	...
	<div style={{fontSize:12, fontWeight:"bold"}}>2023-07-12T03:08:45</div>
	</div>
...
<div style={{display: "tableCell",
 ...
 <div style={{marginLeft: "25px",
    ...
    boxShadow: "0 4px 8px 0 rgba(0, 0, 0, 0.2) 0 6px 20px 0 rgba(0, 0, 0, 0.19)"}}><img src={PDFLOGO} width="76px" height="auto"/></div>
</div>
<div style={{display: "tableCell",width:100}}>
<div style={{ padding: "10px",
  marginTop: "10px", textAlign: "right",
...
<div style={{ padding: "10px", marginTop: "10px", marginLeft: 20,marginRight: 20}}><h2 style={{fontSize:"18px", marginBlockStart:0, marginBlockEnd: 0, textAlign:"left"}}>Executives Detail</h2></div>
<div style={{ padding: "10px",marginTop: "10px",marginLeft: 20, marginRight: 20}}>
<table style={{border:"1px solid #d7d3d3", fontSize:11, fontWeight:550}} width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td style={{backgroundColor:"#5d44ff", border:"1px solid #d7d3d3", width:"20px", fontSize:"8px", color:"#fff", padding:"5px", textAlign:"left"}}>S.No.</td>
	 <td style={{backgroundColor:"#5d44ff", border:"1px solid #d7d3d3", color:"#fff", padding:"5px", fontSize:12, textAlign:"left"}}>	Executive Name</td>
	   <td style={{backgroundColor:"#5d44ff", border:"1px solid #d7d3d3", color:"#fff", padding:"5px", fontSize:12, textAlign:"left"}}>Designation	</td>
	    <td style={{backgroundColor:"#5d44ff", border:"1px solid #d7d3d3", color:"#fff", padding:"5px", fontSize:12, textAlign:"left"}}>Email</td>
		 <td style={{backgroundColor:"#5d44ff", border:"1px solid #d7d3d3", color:"#fff", padding:"5px", fontSize:12, textAlign:"left"}}>Phone</td>
		  <td style={{backgroundColor:"#5d44ff", border:"1px solid #d7d3d3", color:"#fff", padding:"5px", fontSize:12, textAlign:"left"}}>Mobile</td>
		  
   
  </tr>

  <tr>
    <td style={{border:"1px solid #d7d3d3", padding:"5px", textAlign:"left"}}>1.</td>
    <td style={{border:"1px solid #d7d3d3", padding:"5px", textAlign:"left"}}>Subodh Sinha</td>
    <td style={{border:"1px solid #d7d3d3", padding:"5px", textAlign:"left"}}>Head Corporate Projects</td>
    <td style={{border:"1px solid #d7d3d3", padding:"5px", textAlign:"left"}}>subodh.sinha@dabur.com </td>
    <td style={{border:"1px solid #d7d3d3", padding:"5px", textAlign:"left"}}>91 120 3962100</td>
    <td style={{border:"1px solid #d7d3d3", padding:"5px", textAlign:"left"}}>91 120 4182100</td>
  
  </tr>
  <tr>
    <td style={{border:"1px solid #d7d3d3", padding:"5px", textAlign:"left"}}>2.</td>
    <td style={{border:"1px solid #d7d3d3", padding:"5px", textAlign:"left"}}>Balraj Karnati</td>
       <td style={{border:"1px solid #d7d3d3", padding:"5px", textAlign:"left"}}>Area Sales Manager</td>
    <td style={{border:"1px solid #d7d3d3", padding:"5px", textAlign:"left"}}>Balraj.sinha@dabur.com </td>
     <td style={{border:"1px solid #d7d3d3", padding:"5px", textAlign:"left"}}>91 120 3962100</td>
    <td style={{border:"1px solid #d7d3d3", padding:"5px", textAlign:"left"}}>91 120 4182100</td>
    
  </tr>
  <tr>
    <td style={{border:"1px solid #d7d3d3", padding:"5px", textAlign:"left"}}>3.</td>
    <td style={{border:"1px solid #d7d3d3", padding:"5px", textAlign:"left"}}>Lavanya John</td>
    <td style={{border:"1px solid #d7d3d3", padding:"5px", textAlign:"left"}}>Human Resources Executive</td>
    <td style={{border:"1px solid #d7d3d3", padding:"5px", textAlign:"left"}}>lavanya@dabur.com</td>
    <td style={{border:"1px solid #d7d3d3", padding:"5px", textAlign:"left"}}>91 120 3962100</td>
    <td style={{border:"1px solid #d7d3d3", padding:"5px", textAlign:"left"}}>91 120 4182100</td>
   
  </tr>
  <tr>
    <td style={{border:"1px solid #d7d3d3", padding:"5px", textAlign:"left"}}>4.</td>
    <td style={{border:"1px solid #d7d3d3", padding:"5px", textAlign:"left"}}>K Satish</td>
     <td style={{border:"1px solid #d7d3d3", padding:"5px", textAlign:"left"}}>Brand Activation Manager</td>
    <td style={{border:"1px solid #d7d3d3", padding:"5px", textAlign:"left"}}>k@dabur.com</td>
      <td style={{border:"1px solid #d7d3d3", padding:"5px", textAlign:"left"}}>91 120 3962100</td>
     <td style={{border:"1px solid #d7d3d3", padding:"5px", textAlign:"left"}}>91 120 4182100</td>
   
  </tr>
  <tr>
    <td style={{border:"1px solid #d7d3d3", padding:"5px", textAlign:"left"}}>5.</td>
     <td style={{border:"1px solid #d7d3d3", padding:"5px", textAlign:"left"}}>Subodh Sinha</td>
     <td style={{border:"1px solid #d7d3d3", padding:"5px", textAlign:"left"}}>Head Corporate Projects</td>
    <td style={{border:"1px solid #d7d3d3", padding:"5px", textAlign:"left"}}>subodh.sinha@dabur.com </td>
    <td style={{border:"1px solid #d7d3d3", padding:"5px", textAlign:"left"}}>91 120 3962100</td>
  ...
  <tr>
    <td style={{border:"1px solid #d7d3d3", padding:"5px", textAlign:"left"}}>6.</td>
     <td style={{border:"1px solid #d7d3d3", padding:"5px", textAlign:"left"}}>K Satish</td>
      <td style={{border:"1px solid #d7d3d3", padding:"5px", textAlign:"left"}}>Brand Activation Manager</td>
    <td style={{border:"1px solid #d7d3d3", padding:"5px", textAlign:"left"}}>k@dabur.com</td>
     <td style={{border:"1px solid #d7d3d3", padding:"5px", textAlign:"left"}}>91 120 3962100</td>
  ...
  <tr>
    <td style={{border:"1px solid #d7d3d3", padding:"5px", textAlign:"left"}}>7.</td>
    <td style={{border:"1px solid #d7d3d3", padding:"5px", textAlign:"left"}}>Lavanya John</td>
  ...
  <tr>
    <td style={{border:"1px solid #d7d3d3", padding:"5px", textAlign:"left"}}>8.</td>
    <td style={{border:"1px solid #d7d3d3", padding:"5px", textAlign:"left"}}>Balraj Karnati</td>
  ...
  <tr>
    <td style={{border:"1px solid #d7d3d3", padding:"5px", textAlign:"left"}}>9.</td>
    <td style={{border:"1px solid #d7d3d3", padding:"5px", textAlign:"left"}}>Balraj Karnati</td>
