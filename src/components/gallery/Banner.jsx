...
import GalleryHeaderImage from '../../assets/images/gallery-header.jpg'
const BannerSection=()=>{
        ...
        <div className="container pb-md-4">
            <div className="row align-items-center py-4">
                <div className="col-md-6 pr-lg-5 ">
                    ...
                    <span>Great </span>Memories</h3>
                 <p className="mr-5">Enjoy Our Gallery</p>
                ...
                <div className="col-md-6 mt-md-0 mt-5 mb-lg-0 mb-5 right-banner-2 position-relative">
                    <div className="sub-banner-inner-image">
                        <img src={GalleryHeaderImage}
                            className="img-fluid radius-image-full position-relative" alt=" "/>                        
                    </div>
                </div>
                <ul className="breadcrumbs-custom-path">
                <li><a href="index.html">Home</a></li>
                <li className="active"><i className="fas fa-angle-right mx-2"></i>Gallery</li>
            </ul>
            </div>
        </div>
    </div>
