...
import TermsHeaderImage from '../../assets/images/terms-conditions-header.jpg'
const BannerSection=()=>{
    ...
    <div className="banner-content">
        <div className="container pb-md-4">
            <div className="row align-items-center py-4">
                ...
                <li className="active"><i className="fas fa-angle-right mx-2"></i>Terms and Conditions</li>
            </ul>
            </div>
        </div>
    </div>
