            ...
            <div className="row footer-top-29">
                ...
                <div className="row">
                  ...
                  <div className="col-md-3 col-6 footer-list-29">
                    <ul>
                      ...
                      <li>
                        <NavLink to={"/our-data"}>Our Data</NavLink>
                      </li>
                      <li>
                  ...
                  <div className="col-md-3 col-6 footer-list-29 mt-md-0 mt-4">
                    <ul>
                      ...
                      <li>
                        <NavLink to={"/direct-dials"}>Direct Dials</NavLink>
                      </li>
                      <li>
                        <NavLink to={"/b2b-data"}>B2B Data</NavLink>
                      </li>
                      <li>
              ...
              <div className="col-lg-3 footer-contact-list mt-lg-0 mt-md-5 mt-4">
                ...
                <ul>
                  <li>
                    ...
                    <strong style={{ marginLeft: 15 }}>
                      <a href="#"> +91-9560244995</a>
                    </strong>
                  </li>
                  <li>
                    <i className="fa fa-envelope"></i>
                    <strong style={{ marginLeft: 15 }}>
                      <a href="mailto:sales@beyondleadz.com">
                        sales@beyondleadz.com
                      </a>
                    </strong>
                  </li>
                </ul>
                ...
                <div className="main-social-footer-29">
                  ...
                  <a href="#google" className="google-plus-g">
